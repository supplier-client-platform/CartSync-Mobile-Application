angular.module('app.services', []).factory('fireBaseData', function($firebase, $firebaseArray) {
    var ref = new Firebase("https://sepii-client-app.firebaseio.com/"),
        refCart = new Firebase("https://sepii-client-app.firebaseio.com/cart"),
        refUser = new Firebase("https://sepii-client-app.firebaseio.com/users"),
        refCategory = new Firebase("https://sepii-client-app.firebaseio.com/category"),
        refOrder = new Firebase("https://sepii-client-app.firebaseio.com/orders"),
        refFeatured = new Firebase("https://sepii-client-app.firebaseio.com/featured"),
        refMenu = new Firebase("https://sepii-client-app.firebaseio.com/menu");
    return {
        ref: function() {
            return ref;
        },
